# Shopware 5 on Apache with PHP 7.2 on Debian 9 (stretch)

This image provides Shopware 5 in an Apache, PHP 7.2 Debian 9 environment.
...
docker run -u ${UID}:0 -p ${PORT}:8080 -v ${WEB_ROOT}:/var/www/ 1and1internet/debian-9-apache-php-7.2-shopware-5
```
